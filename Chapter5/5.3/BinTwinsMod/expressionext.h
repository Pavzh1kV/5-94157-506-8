...
public :
    ...
    {
        memoryManagement->release(ptr, sizeof(Integer));
    }
};
...
public :
    ...
    void operator delete(void * ptr)
    {
        memoryManagement->release(ptr, sizeof(Double));
    }
};
...
public :
    ...
    void operator delete(void * ptr)
    {
        memoryManagement->release(ptr, sizeof(Binary));
    }
};
...
public :
    ...
    void operator delete(void * ptr)
    {
        memoryManagement->release(ptr, sizeof(UnaryFunction));
    }
};
